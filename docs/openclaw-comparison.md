...
Thread A (build task):
  ...
  → Writes to memory/MEMORY.md: "gx-backend uses X pattern for deployments"
  → Writes to memory/daily/2026-04-13.md: "14:30 — Thread A: discovered deployment pattern in gx-backend"
...
| Skill | Source | File |
|---|---|---|
| `/review-pr` | `openclaw/memory/pr-review-runbook.md` + `gx-backend-review.md` | `.claude/skills/review-pr/SKILL.md` |
...
| `gx-backend-review.md` | 8-phase code review guide | Port to `memory/runbooks/` |
...
| `slack-users.json` | GrowthX Slack user directory | Port to `memory/` |
