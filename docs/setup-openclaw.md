...
```bash
git clone https://github.com/anmolm-growthx/Friday ~/Documents/GitHub/Friday
cd ~/Documents/GitHub/Friday
bun install
```
...
```json
REPOS=[{"name":"your-backend","path":"/Users/anmol/Projects/your-backend","defaultBase":"origin/main"},{"name":"your-frontend","path":"/Users/anmol/Projects/your-frontend","defaultBase":"origin/main"}]
```
