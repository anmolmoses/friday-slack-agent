/**
 * Pre-send lint for vibes / sandbox channels (#cafeteria, #fridaytest).
 *
 * Background — the Prickle thread (#cafeteria, 2026-04-01) saw Friday spiral
 * across ~20 self-deprecating messages chasing Pranav's bait. Operational
