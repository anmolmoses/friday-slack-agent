 ...
 * explicit `setupScript` is configured. gx-backend / gx-admin-client /
 * gx-client-next ship one; it does branch resolution + env copy + MCP
...
export class WorktreeManager {
   ...
   * outside the repo's worktree dir (defends Anmol's checkouts and the clone
   ...
   * `git worktree remove` at the clone root or one of Anmol's checkouts.
   */
