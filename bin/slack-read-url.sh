...
#
# Bot token is for teamgrowthx.slack.com. For growthxclub.slack.com messages,
...
if [ "$WORKSPACE" != "teamgrowthx" ]; then
  echo "Warning: URL is for '$WORKSPACE.slack.com'. Bot token is for teamgrowthx — this call will likely fail with channel_not_found." >&2
fi
